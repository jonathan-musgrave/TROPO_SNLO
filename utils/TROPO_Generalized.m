...
function TROPO_Generalized(lam0,crystal,I0,res,N)
% bright-bright
name = strcat(crystal.name,'lamp_',num2str(round(lam0.p*1e9)),'lams_',num2str(round(lam0.s*1e9)),'lami_',num2str(round(lam0.i*1e9)),'dk_',num2str(crystal.dk./pi),'pi','Ip0',num2str(I0.p));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-----general definition-----%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% global c eps_0;  
noise = 1e-12;
