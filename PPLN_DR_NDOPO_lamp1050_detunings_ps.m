...
N.w  = 400*1; % Time slices 
N.rt = 500*1; % Round trip number
N.z  = 20; % LNL/N.z = dz;
lam0.p = 1050e-9;
lam0.s = 1550e-9;
I0.p = 5; I0.s = 0; I0.i = 0; % CW pump Powers
...
res.delta_p  = -0.2; 
res.delta_s  = lam0.p./lam0.s.*res.delta_p;
res.delta_i  = res.delta_p-res.delta_s;
TROPO_Generalized(lam0,crystal,I0,res,N)
ff = gcf;
run('tilefigs.m')
pause(5)
disp(strcat('Figures after',num2str(ff.Number)',' are from Next run case'))
